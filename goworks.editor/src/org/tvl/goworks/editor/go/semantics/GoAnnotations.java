...
public class GoAnnotations {
    ...
    public static final ObjectProperty<TerminalNode<Token>> LOCAL_TARGET = new ObjectProperty<>("local-target");
    ...
    public static final ObjectProperty<ParserRuleContext<Token>> QUALIFIER = new ObjectProperty<>("qualifier");
    public static final ObjectProperty<TerminalNode<Token>> UNQUALIFIED_LINK = new ObjectProperty<>("unqualified-link");
    ...
    public static final ObjectProperty<ParserRuleContext<Token>> EXPLICIT_TYPE = new ObjectProperty<>("explicit-type");
    public static final ObjectProperty<ParserRuleContext<Token>> IMPLICIT_TYPE = new ObjectProperty<>("implicit-type");
